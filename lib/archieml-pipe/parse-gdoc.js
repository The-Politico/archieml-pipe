...
var parseGDoc = function parseGDoc(dom, archie) {
  var tagHandlers = {
  ...
  try {
    ...
    _fsExtra2.default.writeJSON(_path2.default.resolve(process.cwd(), archie.exportPath), archieData);
    return archieData;
  } catch (e) {
    _logging2.default.log('error', 'Cannot access that Google Doc (Are you sure you\'ve shared it?)', e);
  }
  return null;
};
